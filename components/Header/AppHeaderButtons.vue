<template>
  <div class="buttons" :class="{darken}">
    <div class="buttons__button" @click="$router.push('/search')">
      <svg width="20" height="20" id="search" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
